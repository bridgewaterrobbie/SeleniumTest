...
/**
 * Created by Robbie Bridgewater on 10/3/2014.
 */
public class Presentation {
    ...
    {
        login();
        h.assertElementExists(By.xpath(".//*[@id='content']/div[1]/div/div/div/div/div[2]"),"Byline");
        h.assertElementExists(By.cssSelector(".about-the-author>p"), "Summary");

        try {
            h.assertElementExists(By.cssSelector(".field.field-name-body>p"),"Summary");
            h.assertElementExists(By.xpath(".//*[@id='content']/div[1]/div[4]/div/div/div/a[1]/span"), "Facebook");
            h.assertElementExists(By.xpath(".//*[@id='content']/div[1]/div[4]/div/div/div/div[1]/a"),"ShareURL");
